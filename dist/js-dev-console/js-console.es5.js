    ...
    */
    ...
    var JsConsole = /** @class */ (function () {
        ...
        JsConsole.prototype.componentDidLoad = function () {
            ...
            this.updateAutoCompleteOptions = __chunk_1.debounce(function () { return _this.updateAutoCompleteOptionsUtil(); }, 300);
        };
        ...
        JsConsole.prototype.render = function () {
            ...
            }))), h("span", { class: { "prompt": true, "open": this.showHistory }, onTouchStart: function (e) { return _this.handlePromptClick(e); }, onMouseDown: function (e) { return _this.handlePromptClick(e); } }, ">"), h("input", { autoCapitalize: "off", autoCorrect: "off", autoComplete: "off", list: "completionOptions", id: "input-area", class: "input-area", spellCheck: false, size: 250, value: this.input, onInput: function (event) { return _this.promptChange(event); }, onKeyDown: function (event) { return _this.handleKeyboard(event); } }), h("data-list", { data: this.completionOptions, name: "completionOptions" }), h("span", { class: "clear", onTouchStart: function (e) { return _this.clear(e); }, onMouseDown: function (e) { return _this.clear(e); } }, h("span", null, "\u2715"))), h("div", { class: "scroll-marker" }))) : "";
        };
