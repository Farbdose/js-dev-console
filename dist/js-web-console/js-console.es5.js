...
JsWebConsole.loadBundle('js-console', ['exports'], function (exports) {
    ...
    var JsConsole = /** @class */ (function () {
        ...
        JsConsole.prototype.render = function () {
            ...
            }))), h("span", { class: "prompt" }, ">"), h("textarea", { id: "input-area", class: "input-area", autoFocus: true, spellCheck: false, value: this.input, rows: this.rows, onKeyDown: function (event) { return _this.handleInputChange(event); } })), h("div", { class: "scroll-marker" })));
        };
